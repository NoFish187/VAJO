...
function keyDown(e) {
 ...
 // Funktion zum Starten des Spiel-Loops
 function startGameLoop() {
     gameInterval = setInterval(gameLoop, 150);
 }

 // Funktion zum Stoppen des Spiel-Loops
 function stopGameLoop() {
     clearInterval(gameInterval);
 }

// Funktion zum Anzeigen des Game Over Popups
function showGameOverPopup(score) {
    document.getElementById('finalScore').textContent = score; // Score anzeigen
    document.getElementById('gameOverPopup').style.display = 'flex'; // Popup anzeigen
    stopGameLoop(); // Spiel pausieren
}
 ...
 function startTimer() {
     ...
     let timer = setInterval(function() {
         ...
         if (countdown <= 0) {
             ...
             startGameLoop(); // Spiel-Loop fortsetzen
         }
     }, 1000);
 }
 ...
 // Popup beim Laden der Seite anzeigen und Spiel pausieren
 window.onload = function() {
     document.getElementById('popup').style.display = 'flex';
     stopGameLoop(); // Spiel-Loop anhalten
 };
